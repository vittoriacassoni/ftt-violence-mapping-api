  ...
  async createReport(report) {
    try {
      ...
      var reports = await conn
        ...
        .input('LATITUDE', sql.VarChar, report.latitude)
        .input('LONGITUDE', sql.VarChar, report.longitude)
        ...
        .query(
          'INSERT INTO REPORTS VALUES (@LATITUDE, @LONGITUDE, @ADDRESS, @CEP, @DATE, @DESCRIPTION, @TYPE, @ID_USER)'
        );
